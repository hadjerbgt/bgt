import 'package:project/app11/result.dart';
                ...
                Table(
                    ...
                    children: [
                      ...
                      TableRow(children: [
                        TableCell(
                            child: Text(
                              "Contenu scientifique : clarté de la problématique, méthodologie de travail,conclusion,etc.",
                              textAlign: TextAlign.center,
                            )),
                        TableCell(
                            child: Text(
                      ...
                      TableRow(children: [
                        TableCell(
                            child: Text(
                              "Effort développement / Analyse: originalité",
                              textAlign: TextAlign.center,
                            )),
                        TableCell(
                            child: Text(
                  ...
                  onTap: () {
                    if (note1Controller.text != "" ||
                      ...
                      Fluttertoast.showToast(
                          ...
                          webBgColor:
                          "linear-gradient(to right, #6699CC, #6699CC)",
                          webPosition: "right");
                    }
                  },
                  child: Container(
